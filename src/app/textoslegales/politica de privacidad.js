class miPoliticadeprivacidad extends HTMLElement {
    ...
    connectedCallback() {
      ...
      <section class="primera">
          ...
          <div>
             <p>
                Jose Antonio Lopez Baena te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios que puedan ser recabados durante la navegación a través del sitio Web https://microdeveloper.es.
            </p>
            <p>
                En este sentido, Jose Antonio Lopez Baena cumple con el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo de 27 de abril de 2016 relativo a la protección de las personas físicas (RGPD).
            </p>
            <p>
            ...
            <p>
                Para navegar por https://microdeveloper.es no es necesario que facilites ningún dato personal.
            </p>
            <p>
            ...
            <p>
                El ejercicio de estos derechos es personal y por tanto debe ser ejercido directamente por el interesado, solicitándolo directamente al Titular, lo que significa que cualquier cliente, suscriptor o colaborador que haya facilitado sus datos en algún momento, puede dirigirse a Jose Antonio Lopez Baena y pedir información sobre los datos que tiene almacenados y cómo los ha obtenido, solicitar la rectificación de los mismos, solicitar la portabilidad de sus datos personales, oponerse al tratamiento, limitar su uso o solicitar la cancelación de esos datos en los ficheros del Titular.
            </p>
            <p>
                Para ejercitar tus derechos de acceso, rectificación, cancelación, portabilidad y oposición tienes que enviar un correo electrónico a microa4@gmail.com junto con la prueba válida en derecho como una fotocopia del D.N.I. o equivalente.
            </p>
            <p>
            ...
            <p>
                Cuando te conectas al sitio Web para mandar un correo al Titular, te suscribes a su boletín estás facilitando información de carácter personal de la que el responsable es Jose Antonio Lopez Baena. Esta información puede incluir datos de carácter personal como pueden ser tu dirección IP, nombre y apellidos, dirección física, dirección de correo electrónico, número de teléfono, y otra información. Al facilitar esta información, das tu consentimiento para que tu información sea recopilada, utilizada, gestionada y almacenada por— OVH — sólo como se describe en el Aviso Legal y en la presente Política de Privacidad.
            </p>
            <p>
            ...
            <p>
                ...
                Para gestionar las redes sociales. Jose Antonio Lopez Baena tiene presencia en redes sociales. Si te haces seguidor en las redes sociales del Titular el tratamiento de los datos personales se regirá por este apartado, así como por aquellas condiciones de uso, políticas de privacidad y normativas de acceso que pertenezcan a la red social que proceda en cada caso y que has aceptado previamente.
                ...
                Navegación Web
                Al navegar por https://microdeveloper.es se pueden recoger datos no identificativos, que pueden incluir, la dirección IP, geolocalización, un registro de cómo se utilizan los servicios y sitios, hábitos de navegación y otros datos que no pueden ser utilizados para identificarte.
                ...
                Como Usuario del sitio Web eres el único responsable de la veracidad y corrección de los datos remitidos al sitio Web exonerando a Jose Antonio Lopez Baena de cualquier responsabilidad al respecto.

                Aceptación y consentimiento
                Como Usuario del sitio Web declaras haber sido informado de las condiciones sobre protección de datos de carácter personal, aceptas y consientes el tratamiento de los mismos por parte de Jose Antonio Lopez Baena en la forma y para las finalidades indicadas en esta Política de Privacidad.

                Revocabilidad
                Para ejercitar tus derechos de acceso, rectificación, cancelación, portabilidad y oposición tienes que enviar un correo electrónico a microa4@gmail.com junto con la prueba válida en derecho como una fotocopia del D.N.I. o equivalente.

                El ejercicio de estos derechos no incluye ningún dato que Jose Antonio Lopez Baena esté obligado a conservar con fines administrativos, legales o de seguridad.
                ...
                Quiénes somos
                La dirección de nuestra web es: https://microdeveloper.es.
