        ...
        <div class="form-center">
            ...
            <form  role="form" action="" method="post" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="name form-control" placeholder="Nombre" id="name" type="text" name="Nombre" autofocus required />
                    </div>
                </div>
                <div class="form-group">
                    <label for="email" class="col-sm-4 control-label">Email:</label>
                    <div class="col-sm-8">
                        <input class="email form-control" placeholder="Email" id="email" type="email" name="Email" autofocus required />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea class="message form-control" rows="5" name="comentario" id="comment"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-4"></div>
                ...
                <div class="form-group">
                    <div class="col-sm-4"></div>
                    <div class="col-sm-8">
                        <button type="submit" class="fa fa-paper-plane btn btn-block btn-success">Enviar Formulario</button>
                    </div>
                </div>
            </form>
        </div>
