...
El segundo paso fue comenzar un Bootcamp de programación en las instalaciones de Greekshubs situada  junto al muelle del Grao de Valencia, en junio de 2020, tras esto nos hemos visto inmersos en el problema de la pandemia causada por el famoso Coronavirus lo que me imposibilita mucho mas la incorporación laboral.
Durante este tiempo he intentado ponerme a la altura de las competencias laborales necesarias para unirme a la informática y sobretodo a la programación a la vez que trabajaba.
El primer paso fue aprender a manejar y familiarizarme con los servidores y host web, lo primero fue convertir VPS de OVH en servidor y subir paginas que ya tenia creadas, también he adquirido una licencia como desarrollador ilimitada de Wordpress:
El tema DIVI junto al contructor DIVI BUILDER.
...
La primera pagina creada fue como proyecto de fin de grado superior A.S.I.R. para un equipo de juegos online, fue desarrollada con HTML, CSS y PHP, el uso del PHP fue elegido por mis conocimientos en C++ por lo que fue más fácil adaptarme este lenguaje en ese momento.
Esta dispone de conexión con el servidor del juego y muestra equipos y guerras en tiempo real, esta conexión se crea con la API de Clash of Clans que cede el acceso a la lectura de una hoja JSON la que es adaptada y maquetada imitando al juego.
